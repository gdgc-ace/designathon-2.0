  ...
  useImperativeHandle(ref, () => ({
    animate: () => {
      ...
      const cardTl = gsap.timeline({
        defaults: { ease: "power1.inOut", duration: 1 ,delay:0.4 },
      });

      return cardTl
        .from(textArray, { y: 50, opacity: 0, stagger: 0.2 })
        .from(".tl-card2-info", { clipPath: "polygon(50% 0%, 50% 0%, 50% 100%, 50% 100%)"  })
    ...
    >
      <div className="h-[80vh] w-full flex flex-col items-center mt-2">
        ...
        <div className="z-10 grid grid-cols-4 flex-1 items-center text-center relative">
          <img
            src="images/timeline/galaxy_2.avif"
            alt="galaxy"
          ...
          <div className="flex justify-end col-span-1 self-end pb-10  items-start gap-2">
            ...
            <OrangeRect fill="#f5f5f5" ref={orangeRectRef2} className="h-7 w-7" />
          </div>
          <div className="flex flex-col justify-center items-center gap-24 col-span-1 pb-30">
            <div className="flex">
              ...
              <OrangeRect fill="#f5f5f5" ref={orangeRectRef1} className="h-4 w-4" />
            </div>
          ...
          <img
            src="images/timeline/galaxy_2_details.svg"
            ref={statsImgRef}
            alt=""
